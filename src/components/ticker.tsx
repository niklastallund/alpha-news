...
const Ticker = () => (
  <div className="bg-white text-black border-2 border-red-600 py-2 overflow-hidden rounded-lg shadow dark:bg-gray-900 dark:text-gray-100 dark:border-red-400 transition-colors duration-300">
    <Marquee
