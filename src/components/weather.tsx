  ...
  return (
    <div className="bg-card text-foreground p-8 sm:p-10 w-full max-w-md border rounded-sm border-t-4 border-t-red-500 transition-all duration-300 ">
      ...
      <div className="mt-4 text-lg">
        ...
        {weather && (
          <div className="bg-card text-card-foreground shadow-lg rounded-2xl p-6 max-w-md mx-auto flex flex-col items-center text-center border border-border">
            ...
            <div className="space-y-2 text-lg">
              <p className="capitalize text-muted-foreground font-medium">
                {weather.weather[0].description}
              </p>
              <p className="capitalize text-muted-foreground font-medium">
                {" "}
