...
//   return (
//     <div role="listitem" className="bg-card text-muted-foreground ">
//       <Wrapper
//         href={href}
...
//   title = "Kontakta news-alpha",
//   subtitle = "Tips? Frågor? Hör av dig!",
//   email = "redaktionen@news-alpha.se",
//   phoneDisplay = "011-120111",
//   phoneHref = "+4611120111",
//   facebookUrl = "#",
//   facebookHandle = "@news-alpha",
//   className,
// }: ContactCardProps) {
//   return (
//     <section
//       className={`
//     w-full max-w-md overflow-hidden border border-border border-t-4 border-t-red-500
//     bg-card text-card-foreground shadow-sm ${className ?? ""}
//   `}
//       aria-labelledby="kontakta-title"
//     >
...
//           {title}
//         </h2>
//         <p className="mt-0.5 text-[0.95rem] text-muted-foreground">{subtitle}</p>
//       </header>
...
//         <ContactItem
//           href={`mailto:${email}`}
//           title="Mejla redaktionen"
//           subtitle={email}
//           ariaLabel={`Mejla redaktionen på ${email}`}
//         >
//           {/* mail-ikon */}
//           <svg
//             viewBox="0 0 24 24"
...
//           ariaLabel="Följ oss på Facebook"
//         >
//           {/* facebook-ikon */}
//           <svg
//             viewBox="0 0 24 24"
...
//         <ContactItem
//           href={`tel:${phoneHref}`}
//           title="Ring redaktionen"
//           subtitle={phoneDisplay}
//           ariaLabel={`Ring redaktionen på ${phoneDisplay}`}
//         >
//           {/* phone-ikon */}
//           <svg
//             viewBox="0 0 24 24"
...
function ContactItem({
  ...
  return (
    <div
      role="listitem"
      className="bg-card text-muted-foreground border-t border-b border-gray-400 dark:border-gray-600"
    >
      <Wrapper
        href={href}
        target={isExternal ? "_blank" : undefined}
...
export default function ContactCard({
  ...
  return (
    <section
      className={`
    w-full max-w-md overflow-hidden border border-gray-400 dark:border-gray-600 border-t-4 border-t-red-500
    bg-card text-card-foreground shadow-sm ${className ?? ""}
  `}
